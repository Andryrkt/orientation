...
export class AuthController {
  ...
  // Limites resserrées par rapport au throttler global (100/min) sur les routes sensibles au
  // brute-force / à l'énumération de comptes ou au spam de créations/emails.
  @Public()
