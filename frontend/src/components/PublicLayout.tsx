  ...
  return (
    <div className="min-h-screen flex flex-col">
      <header className="bg-white border-b border-slate-200 sticky top-0 z-10">
        <div className="max-w-6xl mx-auto px-4 py-2 flex items-center justify-between flex-wrap gap-y-1">
          ...
          <nav className="flex items-center gap-1 flex-wrap">
            ...
            <NavLink to="/coachs" className={navLinkClass}>Coachs</NavLink>
            {user?.role === 'ADMIN' && (
            ...
            {user ? (
              <>
                ...
                <NavLink to="/mes-resultats" className={navLinkClass}>Mes résultats</NavLink>
